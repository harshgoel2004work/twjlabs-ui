...
npx @twjlabs/ui add <component-name>
  ...
  <Tab value="pnpm">
    ```bash
    pnpm dlx @twjlabs/ui add <component-name>
    ```
  </Tab>
</Tabs>


Replace `<component-name>` with the name of the component you wish to add, such as `button`, `dropdown-menu`, or `navbar`. The CLI will handle the installation and setup for you.
